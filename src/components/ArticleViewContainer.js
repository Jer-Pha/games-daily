    ...
    <>
      <div>
        ...
        <div
          ...
          className="flex flex-col w-full desktop:items-center overflow-x-hidden overflow-y-auto gutter max-h-[calc(100vh-59px)] tablet:max-h-[calc(100vh-43px)] pr-1 tablet:pr-0"
        >
          {selectedView === "topics" && (
            <ArticlesByTopicView
