...
export default function ArticleFilterMenu({
  ...
  return (
    <div className="w-60 desktop:w-80 p-4">
      ...
      <div
        id="filter-options"
        className={`px-4 py-2 border-t-0 border-[1px] border-[var(--text-color)] max-h-[calc(100vh-182px)] tablet:max-h-[calc(100vh-166px)] overflow-y-auto overflow-x-hidden text-left ${
          activeTab === "outlet"
